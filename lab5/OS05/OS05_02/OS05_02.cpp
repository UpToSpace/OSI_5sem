...
int main(int argc, char* argv[])
{
	try {
		if (argc == 4) {
			...
			LPCWSTR path1 = L"D:\\University\\OS\\lab5\\OS05\\Debug\\OS05_02x.exe";
			LPCWSTR path2 = L"D:\\University\\OS\\lab5\\OS05\\Debug\\OS05_02x.exe";
		...
		else cout << "Enter parameters" << endl;
	}
	catch (string err) {
		cout << err << endl;
	}
